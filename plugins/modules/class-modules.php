...
class Modules
{
	 ...
	 * Class instance.
	 *
	 * @var ModuleACF\Modules instance.
	 */
	...
	public function render_modules($post_id)
	{
		if (function_exists('have_rows') && have_rows('content_modules', $post_id)) {
			while (have_rows('content_modules', $post_id)) {
				...
				$layout = str_replace('-', '-', get_row_layout());
	 ...
	 *
	 * Each module must include a module.php file.
	 *
	...
	{
		wp_enqueue_style('modules-admin-styles', get_stylesheet_directory_uri() . '/plugins/modules/css/admin-styles.css', array(), filemtime(get_stylesheet_directory() . '/plugins/modules/css/admin-styles.css'));

		wp_register_script('modules-admin-js', get_stylesheet_directory_uri() . '/plugins/modules/js/admin.js', array('jquery'), filemtime(get_stylesheet_directory() . '/plugins/modules/js/admin.js'));

		wp_enqueue_script('modules-admin-js');
